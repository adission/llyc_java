 ...
 * @author 秦建辉
 */
public class FaceTest implements Initializable, ISocketServerThreadTask {
    ...
    private void test1() throws IOException, Exception {
        ...
        {   
            ...
            TcpServer = new TcpListenerPlus(Integer.parseInt("8003"), 0, InetAddress.getByName("192.168.199.107"), false);
