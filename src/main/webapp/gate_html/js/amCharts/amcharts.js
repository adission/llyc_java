    ...
    d.AxisBase = d.Class({
        construct: function (a) {
            ...
            if (a) {
                ...
                var g = h.width, h = h.height, k = this.viW, l = this.viH, m = 0, n = a.getBBox().height / 2, p = this.inside, q = this.titleAlign;
        ...
        getBBox: function () {
            ...
            var a, b = this.chart, c = this.showFirstLabel, e = this.showLastLabel, h, f = "", g = d.extractPeriod(this.minPeriod), k = d.getPeriodDuration(g.period,
                g.count), l, m, n, p, q, r = this.firstDayOfWeek, t = this.boldPeriodBeginning;
            a = this.minorGridEnabled;
            var u, x = this.gridAlpha, A, w = this.choosePeriod(0), v = w.period, w = w.count, z = d.getPeriodDuration(v, w);
            z < k && (v = g.period, w = g.count, z = k);
            g = v;
            "WW" == g && (g = "DD");
            this.stepWidth = this.getStepWidth(this.timeDifference);
            var B = Math.ceil(this.timeDifference / z) + 5, D = l = d.resetDateToMin(new Date(this.startTime - z), v, w, r).getTime();
            if (g == v && 1 == w && this.centerLabelOnFullPeriod || this.autoWrap || this.centerLabels)n = z * this.stepWidth, this.autoWrap && !this.centerLabels && (n = -n);
            ...
            var b = d.getPeriodDuration(this.periods[a].period, this.periods[a].count), c = Math.ceil(this.timeDifference / b), e = this.periods;
...
(function () {
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            for (c = 0; c < b.length; c++) {
                ...
                if (e.valueAxis == this) {
                    ...
                    if (!isNaN(a.startTime) && (m = a.categoryAxis)) {
                        var n = m.minDuration(), n = new Date(a.startTime + n / 2), p = d.resetDateToMin(new Date(a.startTime), m.minPeriod).getTime();
            ...
            if (isNaN(a))return NaN;
            var b = this.rotate, c = this.reversed, e = this.axisWidth, d = this.stepWidth, f = this.min, g = this.minReal;
...
(function () {
    ...
    d.RecAxis = d.Class({
        construct: function (a) {
            var b = a.chart, c = a.axisThickness, e = a.axisColor, h = a.axisAlpha, f = a.offset, g = a.dx, k = a.dy, l = a.viX, m = a.viY, n = a.viH, p = a.viW, q = b.container;
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, p) {
            ...
            this.set = A;
            var w = a.axisThickness, v = a.axisColor, z = a.axisAlpha, B = a.tickLength, D = a.gridAlpha, C = a.gridThickness, L = a.gridColor, H = a.dashLength, J = a.fillColor, I = a.fillAlpha, W = a.labelsEnabled;
            n = a.labelRotationR;
            var ea = a.counter, Q = a.inside, oa = a.labelOffset, qa = a.dx, ka = a.dy, Ra = a.orientation, ca = a.position, aa = a.previousCoord, V = a.viH, sa = a.viW, ba = a.offset, da, ta;
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            if (d.ifArray(b)) {
                ...
                for (e = 0; e < b.length; e++) {
                    ...
                    if (!1 !== h.enabled) {
                        ...
                        isNaN(h.alpha);
                        var k = this.marginLeft, f = d.wrappedText(this.container, h.text, f, this.fontFamily, g, "middle", !1, this.divRealWidth - 20);
            ...
            if (a) {
                ...
                var f = d.removePx(d.getStyle(a, "padding-left")), g = d.removePx(d.getStyle(a, "padding-right")), k = d.removePx(d.getStyle(a, "padding-top")), l = d.removePx(d.getStyle(a, "padding-bottom"));
                isNaN(f) || (c -= f);
                isNaN(g) || (c -= g);
                isNaN(k) || (e -= k);
                isNaN(l) || (e -= l);
            ...
            if (this.container && !1 !== a.enabled) {
                ...
                var b = a.y, c = a.text, e = a.align, h = a.size, f = a.color, g = a.rotation, k = a.alpha, l = a.bold, m = d.toCoordinate(a.x, this.realWidth), b = d.toCoordinate(b, this.realHeight);
                m || (m = 0);
                b || (b = 0);
                void 0 === f && (f = this.color);
        ...
        construct: function (a) {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(p))this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
                    var r = this.y - (this.valueAxis.getCoordinate(p) - this.height), r = r * this.valueAxis.rMultiplier, t = 180 - 360 / (this.end - this.start + 1) * m;
                    ...
                    c.push(r);
                    if (!isNaN(q)) {
                        var u = this.y - (this.valueAxis.getCoordinate(q) - this.height), u = u * this.valueAxis.rMultiplier,
            ...
            var a = this.chart, b = this.id, c = this.index, e = this.data, h = this.chart.container, f = this.valueAxis, g = this.type, k = this.columnWidthReal,
                l = this.showBulletsAt;
            isNaN(this.columnWidth) || (k = this.columnWidth);
            isNaN(k) && (k = .8);
            var m = this.useNegativeColorIfDown, n = this.width, p = this.height, q = this.y, r = this.rotate, t = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop, k / 2), x = this.connect, A = [], w = [], v, z, B, D, C = this.chart.graphs.length, L, H = this.dx / this.tcc, J = this.dy / this.tcc, I = f.stackType, W = this.start, ea = this.end, Q = this.scrollbar, oa = "graph-column-";
            Q && (oa = "scrollbar-graph-column-");
            var qa = this.categoryAxis, ka = this.baseCoord, Ra = this.negativeBase,
                ca = this.columnIndex, aa = this.lineThickness, V = this.lineAlpha, sa = this.lineColorR, ba = this.dashLength, da = this.set, ta, fa = this.getGradRotation(), S = this.chart.columnSpacing, X = qa.cellWidth, ya = (X * k - t) / t;
            S > ya && (S = ya);
            var E, y, la, ga = p + 1, Ja = n + 1, Z = 0, qb = 0, rb, sb, eb, fb, tb = this.fillColorsR, Ka = this.negativeFillColors, Da = this.negativeLineColor, Wa = this.fillAlphas, Xa = this.negativeFillAlphas;
            ...
            for (K = W; K <= ea; K++) {
                ...
                var R, P, M, ha, ma = NaN, G = NaN, F = NaN, O =
                    NaN, N = NaN, Oa = NaN, Ea = NaN, Pa = NaN, Fa = NaN, ua = NaN, va = NaN, ia = NaN, ja = NaN, Y = NaN, xb = NaN, yb = NaN, na = NaN, pa = void 0, Ia = tb, Ta = Wa, Ba = sa, wa, za, zb = this.proCandlesticks, kb = this.topRadius, $a = this.pattern;
                ...
                if (Ca) {
                    ...
                    var ma = E.x[qa.id], Ua = this.periodSpan - 1, ra = Math.floor(X / 2) + Math.floor(Ua * X / 2), Aa = ra, lb = 0;
                    ...
                    switch (g) {
                        ...
                        case "candlestick":
                            if (!isNaN(na) && !isNaN(Y)) {
                                ...
                                if (r) {
                                    ...
                                    zb && Y >= na && (Ta = 0);
                                    var pa = new d.Cuboid(h, M, ha, H, J, Ia, Ta, aa, wa, V, fa, u, r, ba, $a, kb, oa), Db, Eb;
                        ...
                        case "ohlc":
                            if (!(isNaN(na) || isNaN(xb) || isNaN(yb) || isNaN(Y))) {
                                ...
                                var mb, nb, ob;
                                if (r) {
                                    var Fb = F - k / 2, Fb = d.fitToBounds(Fb, 0, p), Rb = d.fitToBounds(F, 0, p), Gb = F + k / 2, Gb = d.fitToBounds(Gb, 0, p);
                                    ...
                                    var Hb = G - k / 2, Hb = d.fitToBounds(Hb, 0, n), Sb = d.fitToBounds(G, 0, n), Ib = G + k / 2, Ib = d.fitToBounds(Ib, 0, n);
                        ...
                        if (this.end - this.start <= Tb || 0 === Tb) {
                            ...
                            if ("regular" == I || "100%" == I) {
                                ...
                                if (Wb) {
                                    ...
                                    var Xb = Qa.getBBox(), Yb = Xb.width, Zb = Xb.height, bb, cb, pb = f.totalTextOffset, $b = f.totals[K];
                                    $b && $b.remove();
                                    var db = 0;
            ...
            if (1 < a.length) {
                ...
                var m = this.lineAlpha,
                    n = this.lineThickness, h = this.dashLength, p = this.fillAlphas, q = this.lineColorR, r = this.fillColorsR, t = this.negativeLineColor, u = this.negativeFillColors, x = this.negativeFillAlphas, A = this.baseCoord, w = this.lineColorSwitched;
                w && (q = w);
...
(function () {
    ...
    d.ChartCursor = d.Class({
        construct: function (a) {
            ...
            var a = this.cursorAlpha, b = this.container, c = d.line(b, [0, 0], [0, this.height], this.cursorColor, a, 1),
            ...
            var a = this.chart, b = a.mouseX - this.x, c = a.mouseY - this.y, e = this.vLine, h = this.hLine, b = d.fitToBounds(b, 0, this.width), c = d.fitToBounds(c, 0, this.height);
            ...
            if (this.enabled) {
                ...
                var k = e.categoryAxis,
                    l = e.dx, m = e.dy, n = this.x + 1, p = this.y + 1, q = this.width, r = this.height, t = this.data[a], u;
                this.data[a + 1] && (u = this.data[a + 1]);
                this.fireMoved();
                if (t) {
                    var x = t.x[k.id], A = e.rotate, w = this.stepWidth, v = this.categoryBalloon, z = this.firstTime, B = this.lastTime, D = this.cursorPosition, C = this.zooming, L = this.panning, H = e.graphs;
                    if (e.mouseIsOver || C || L || this.forceShow)if (this.forceShow = !1, L) {
                        b = this.panClickPos;
                        a = this.panClickEndTime;
                        var e = this.panClickStartTime, C = this.panClickEnd, J = this.panClickStart, f = (A ? b - g : b - f) / w;
                        if (!k.parseDates ||
        ...
        construct: function (a) {
            ...
            if (k) {
                c =
                    k.x + d;
                e = k.y + f;
                var l = k.width, k = k.height, m = this.rotate, n = this.chart, p = this.width, q = this.height, r = n.mouseX, t = n.mouseY;
                a = this.initialMouse;
    ...
    d.ChartScrollbar = d.Class({
        inherits: d.SimpleChartScrollbar, construct: function (a) {
            ...
            if (a.enabled) {
                ...
                var b = a.chart, c = b.chartData, e = a.categoryAxis, h = a.rotate, f = a.x, g = a.y, k = a.width, l = a.height, m = b.categoryAxis, n = a.set;
                e.setOrientation(!h);
    ...
    d.AmBalloon = d.Class({
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    var g = this.l, k = this.t, l = this.r, m = this.b, n = this.balloonColor, p = this.fillColor, q = this.borderColor, r = p;
                    void 0 != n && (this.adjustBorderColor ? r = q = n : p = n);
                    var t = this.horizontalPadding, u = this.verticalPadding, x = this.pointerWidth, A = this.pointerOrientation, w = this.cornerRadius, v = c.fontFamily, z = this.fontSize;
                    ...
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    var k = z + u, m = D + t, u = this.shadowAlpha, H = this.shadowColor, t = this.borderThickness, J = this.bulletSize, I;
        ...
        inherits: d.AmChart, construct: function (a) {
            ...
            for (b = 0; b < a.length; b++) {
                ...
                if (c.label && !c.skipTick) {
                    var e = c.ty, e = d.line(this.container, [c.tx0, c.tx, c.tx2], [c.ty0, e, e], this.labelTickColor, this.labelTickAlpha);
...
(function () {
    ...
    d.AmRectangularChart = d.Class({
        inherits: d.AmCoordinateChart, construct: function (a) {
            ...
            var a = this.valueAxes, b, c = this.autoMarginOffset, e = this.fixMargins, d = this.realWidth, f = this.realHeight, g = c, k = c, l = d;
            b = f;
            var m;
            ...
            if (!a.zbSet) {
                ...
                var c = a.color, e = a.fontSize, h = a.zoomOutButtonImageSize, f = a.zoomOutButtonImage.replace(/\.[a-z]*$/i, ""), g = d.lang.zoomOutText || a.zoomOutText, k = a.zoomOutButtonColor, l = a.zoomOutButtonAlpha, m = a.zoomOutButtonFontSize, n = a.zoomOutButtonPadding;
                isNaN(m) || (e = m);
            ...
            var a = this.dx, b = this.dy, c = this.marginLeftReal, e = this.marginTopReal, h = this.plotAreaWidth - 1, f = this.plotAreaHeight -
                1, g = this.plotAreaFillColors, k = this.plotAreaFillAlphas, l = this.plotAreaBorderColor, m = this.plotAreaBorderAlpha;
            ...
            var a = this.valueAxes, b = this.marginLeftReal, c = this.marginTopReal, e = this.plotAreaHeight, h = this.plotAreaWidth, f;
...
(function () {
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var a = this;
            a.destroy();
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, p = a.finalCategory, q = a.valueAxis, r = a.valueAxisX, t = a.initialXValue, u = a.finalXValue, x = a.initialValue, A =
...
(function () {
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, p, q) {
        ...
        h >= x &&
        (h = x);
        var A = 1 / 180 * Math.PI, x = b + Math.sin(e * A) * k, w = c - Math.cos(e * A) * t, v = b + Math.sin(e * A) * f, z = c - Math.cos(e * A) * g, B = b + Math.sin((e + h) * A) * f, D = c - Math.cos((e + h) * A) * g, C = b + Math.sin((e + h) * A) * k, A = c - Math.cos((e + h) * A) * t, L = {
...
(function () {
    ...
    d.Bezier = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m) {
            ...
            var d = Math.round, f = this.getPointOnSegment(a, b, .75), g = this.getPointOnSegment(e, c, .75), k = (e.x - a.x) / 16, l = (e.y - a.y) / 16, m = this.getPointOnSegment(a, b, .375);
...
(function () {
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop, h = this.marginBottom, f = this.horizontalGap,
                g = this.div, k = this.divWidth, l = this.maxColumns, m = this.verticalGap, n = this.spacing, p = k - c - b, q = 0, r = 0, t = this.container;
