/**
 * Created by jiangyanyan on 2017/8/25.
 */
/**
            ...
            },
            {
                ...
                "render": function (data, type, full) {
                    return ' <div class="btn-group"> ' +
                        '<button type="button" class="btn btn-default" title="关闭"><i class="glyphicon glyphicon-thumbs-up text-primary"></i></button> ' +
                        '<button type="button" class="btn btn-default" title="复位"><i class="glyphicon glyphicon-volume-off text-info"></i></button> ' +
