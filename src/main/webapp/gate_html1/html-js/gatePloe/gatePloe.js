...
$(function(){
  ...
  //批量删除选中行
    ...
    // 删除一个
    $('#gatePloe tbody').on('click', '.delRow', function () {
...
$('.panel-title').click(function(){
	$(this).children("i").toggleClass("fa-angle-double-up fa-angle-double-down");
    $('#gateD').toggle();
});
...
function delPloe(ids){
	$.post(urlpath+'GateUserAuth/delsomeAuth',{
		...
		tool(res.code==200,"人员权限删除成功",res.message);
	});
}
