    ...
    switch (options.side) {
      case 'left':
        ...
        panelAnimation.left = '+=' + panelWidth;
          $('i.open').removeClass('fa-angle-double-left').addClass('fa-angle-double-right');
          $('.openLabel').animate({left: "250px"},"fast");
        break;
  ...
  $.panelslider.close = function(callback) {
    ...
    switch(active.data('side')) {
      case 'left':
        bodyAnimation['margin-left'] = '-=' + panelWidth;
        panelAnimation.left = '-=' + panelWidth;
          $('i.open').removeClass('fa-angle-double-right').addClass('fa-angle-double-left');
          $('.openLabel').animate({left: "-10px"},"fast");
        break;
