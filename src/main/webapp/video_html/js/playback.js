...
$('#playback').height($(window).height() - $('.header').height() - 110); //动态加载盒子高度
...
$('#play_btn').click(function(){
    if(v.paused) {
        v.play();
        $('#play_btn span').removeClass('glyphicon-play').addClass('glyphicon-pause');
    }else{
        v.pause();
        $('#play_btn span').removeClass('glyphicon-pause').addClass('glyphicon-play');
    }
});
